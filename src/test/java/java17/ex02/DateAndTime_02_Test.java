...
public class DateAndTime_02_Test {
	...
	public void test_localDate_of() {
		...
		// différentes variables afin de rendre le test passant.
		 ...
		 Month month = result.getMonth();  // Utilisation de Month au lieu d'int pour la vérification
	...
	public void test_with() {
		...
		// TODO  CREE UNE NOUVELLE LOCALDATE A PARTIR DU PRECEDENT EN 05/02/2015 
